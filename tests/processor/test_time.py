...
def test_05_search_mode():
    ...
    assert m.method_calls == [
        call.merge_time_item(merge_properties["timestamp"], merge_properties["atom_base"], merge_properties["atom_version"], 3677820)
    ]
...
def test_06_package_mode():
    ...
    time = Time(output=m)
    merge_properties = [
        dict(timestamp=1, atom="cat/package-3.2.1", atom_base="cat/package", atom_version="3.2.1", count_n="11", count_m="23"),
        dict(timestamp=2, atom="abc/package-0.47.11", atom_base="abc/package", atom_version="0.47.11", count_n="7", count_m="9"),
        dict(timestamp=3, atom="cat/package-3.1.1", atom_base="cat/package", atom_version="3.1.1", count_n="1", count_m="1"),
    ]
    ...
    assert m.method_calls == [
        ...
        call.merge_time_item(merge_properties[1]["timestamp"], merge_properties[1]["atom_base"], merge_properties[1]["atom_version"], 50),
        call.message(" * {}:\n".format(merge_properties[0]["atom_base"])),
        call.merge_time_item(merge_properties[0]["timestamp"], merge_properties[0]["atom_base"], merge_properties[0]["atom_version"], 50),
        call.merge_time_item(merge_properties[2]["timestamp"], merge_properties[2]["atom_base"], merge_properties[2]["atom_version"], 50),
    ]
